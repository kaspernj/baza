...
class Baza::Db
  ...
  delegate *%i[close count delete esc escape escape_column escape_table escape_database escape_index quote_column quote_table quote_value quote_database quote_index insert select single sqlval sql_make_where], to: :driver
